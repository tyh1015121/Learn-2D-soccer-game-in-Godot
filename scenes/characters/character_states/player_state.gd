...
func setup(context_player : Player,context_data : PlayerStateData, context_animation_palyer: AnimationPlayer, context_ball:Ball,context_teammate_detection_area: Area2D,context_ball_detection_area: Area2D,context_own_goal : Goal,context_target_goal : Goal,context_tackle_damage_emitter_area:Area2D, context_ai_behavior: AIBehavior) -> void:
